...
1. [Workflow 1: Code Review Setup](#workflow-1-code-review-setup)
2. [Workflow 2: Feature Development with Multiple Services](#workflow-2-feature-development-with-multiple-services)
3. [Workflow 3: Cleanup Old Worktrees](#workflow-3-cleanup-old-worktrees)
4. [Workflow 4: Emergency Hotfix](#workflow-4-emergency-hotfix)
5. [Workflow 5: Experiment Without Risk](#workflow-5-experiment-without-risk)
6. [Workflow 6: Validate and Fix Registry After Manual Operations](#workflow-6-validate-and-fix-registry-after-manual-operations)

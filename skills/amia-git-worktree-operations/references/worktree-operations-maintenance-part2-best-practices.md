# Worktree Operations: Best Practices

**WHEN TO USE THIS**: When you need guidelines for managing worktrees effectively and avoiding common mistakes.

---

## Table of Contents

1. [Practice 1: Keep Worktrees Updated](#practice-1-keep-worktrees-updated)
2. [Practice 2: Clean Working Tree Before Switching](#practice-2-clean-working-tree-before-switching)
3. [Practice 3: Use Meaningful Worktree Names](#practice-3-use-meaningful-worktree-names)
4. [Practice 4: Lock Worktrees When In Active Use](#practice-4-lock-worktrees-when-in-active-use)
5. [Practice 5: Remove Completed Worktrees Promptly](#practice-5-remove-completed-worktrees-promptly)
6. [Practice 6: Prune Stale Worktrees Regularly](#practice-6-prune-stale-worktrees-regularly)
7. [Practice 7: Document Worktree Purpose](#practice-7-document-worktree-purpose)
...
- For troubleshooting, see [worktree-operations-maintenance-part3-troubleshooting.md](worktree-operations-maintenance-part3-troubleshooting.md)

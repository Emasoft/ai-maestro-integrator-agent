...
4. [Phase 3: Rebase on Origin/Main](#phase-3-rebase-on-originmain)
5. [Phase 4: Handling Rebase Conflicts](#phase-4-handling-rebase-conflicts-if-they-occur)
6. [Phase 5: Force Push Updated Branch](#phase-5-force-push-updated-branch)
7. [Phase 6: Restore Stashed Changes](#phase-6-if-you-stashed-changes-earlier)

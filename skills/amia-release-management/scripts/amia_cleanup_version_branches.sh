...
echo -e "${BLUE}╔════════════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║            AMIA - Version Branch Cleanup Tool                  ║${NC}"
echo -e "${BLUE}╔════════════════════════════════════════════════════════════════╗${NC}"
echo ""
...
echo -e "  • Users on older versions get HTTP 300 errors when updating"
echo -e "  • GitHub API can't distinguish between branch and tag with same name"
echo -e "  • The recommended fix uses explicit refs/tags/ prefix in API calls"
